...
class Test123():
  ...
  def test_123(self):
    ...
    self.driver.find_element(By.ID, "id_registration-email").send_keys("test116@gmail.com")
    self.driver.find_element(By.ID, "id_registration-password1").click()
    self.driver.find_element(By.ID, "id_registration-password1").send_keys("test116")
    self.driver.find_element(By.ID, "id_registration-password2").click()
    self.driver.find_element(By.ID, "id_registration-password2").send_keys("test116")
